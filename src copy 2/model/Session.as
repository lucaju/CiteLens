package model {
	...
	public class Session {
		...
		public function Session(bib:Bibliography) {
			...
			citationFunction.addSubFunction("Agree");
			citationFunction.addOptionToSubFunction("Agree","Fact", false);
			citationFunction.addOptionToSubFunction("Agree","Opinion", false);
			citationFunction.addSubFunction("Neutral");
			citationFunction.addOptionToSubFunction("Neutral","Fact", false);
			citationFunction.addOptionToSubFunction("Neutral","Opinion", false);
			citationFunction.addSubFunction("Disagree");
			citationFunction.addOptionToSubFunction("Disagree","Fact", false);
			citationFunction.addOptionToSubFunction("Disagree","Opinion", false);
			citationFunctionLibrary.push(citationFunction);
			
			citationFunction = new CitationFunction("Further Reading",CitationFunction.UNIQUE);
			citationFunctionLibrary.push(citationFunction);
