package model {
	...
	public class Session {
		...
		public function Session(bib:Bibliography) {
			...
			citationFunction = new CitationFunction(citationFunctionLibrary.length, "Primary Source");
			citationFunctionLibrary.push(citationFunction);
			citationFunction = new CitationFunction(citationFunctionLibrary.length, "Secondary Source");
			citationFunctionLibrary.push(citationFunction);
			citationFunction = new CitationFunction(citationFunctionLibrary.length, "Further Reading");
			citationFunctionLibrary.push(citationFunction);
